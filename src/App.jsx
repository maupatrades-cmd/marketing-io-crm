...
import UpsellWorkspace from './pages/UpsellWorkspace';
...
import LogSaleOnBehalf from './pages/LogSaleOnBehalf';
...
const AuthenticatedApp = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/clients/:id" element={<RouteGuard allowedRoles={["owner", "admin", "field_agent"]} fallbackPath="/"><OwnerClientDetail /></RouteGuard>} />
      ...
      <Route path="/upsell" element={<RouteGuard allowedRoles={["owner", "admin", "cpc", "field_agent"]} fallbackPath="/"><Upsell /></RouteGuard>} />
      <Route path="/upsell/:clientId" element={<RouteGuard allowedRoles={["owner", "admin", "cpc", "field_agent"]} fallbackPath="/"><UpsellWorkspace /></RouteGuard>} />
      ...
      <Route path="/log-sale-on-behalf" element={<RouteGuard allowedRoles={["owner","admin"]} fallbackPath="/"><LogSaleOnBehalf /></RouteGuard>} />
