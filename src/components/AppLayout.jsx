...
const STAFF_NAV = {
  field_agent: [
    ...
    { path: "/sales-opportunities", label: "Sales Opportunities", icon: Search },
    { path: "/upsell", label: "Upsell", icon: ShoppingBag },
  ...
  admin: [
    ...
    { path: "/my-sales", label: "My Sales", icon: Star },
    { path: "/my-invoices", label: "My Invoices", icon: FileText },
    { path: "/log-sale-on-behalf", label: "Log Sale on Behalf", icon: PlusCircle },
